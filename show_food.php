                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Speisen anzeigen</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="show_food">
										<thead>
											<tr>
												<th>Speisename</th>
												<th>Kategorie</th>
										...
										<tbody>
											<tr class="odd gradeX">
												<td>Pommes mit Spinat & Tomatensoße</td>
												<td>Mittagessen</td>
												<td>Pommes frites</td>
												<td>Spinat</td>
												<td>Tomatensoße</td>
